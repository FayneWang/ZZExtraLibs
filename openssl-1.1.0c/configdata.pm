...
our %config = (
  ...
  defines => [ "DSO_WIN32", "NDEBUG", "OPENSSL_THREADS", "OPENSSL_NO_STATIC_ENGINE", "OPENSSL_PIC", "OPENSSL_BN_ASM_PART_WORDS", "OPENSSL_IA32_SSE2", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "MD5_ASM", "RMD160_ASM", "AES_ASM", "VPAES_ASM", "WHIRLPOOL_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
  ...
  openssldir => "",
  options => "--release enable-threads enable-zlib --with-zlib-include=../zlib-1.2.8 --with-zlib-lib=..\\zlib-1.2.8/libs/vc12_Release_MD_Win32/zlib.lib --prefix=H:/ZZWorkspace/ZZExtraLibs/openssl-1.1.0c/libs/vc12_Release_DLL_MD_threads_zlib no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-ec_nistp_64_gcc_128 no-egd no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib-dynamic",
  perl => "D:\\Program Files\\Perlx64\\bin\\perl.exe",
  perlargv => [ "--release", "threads", "zlib", "--with-zlib-include=../zlib-1.2.8", "--with-zlib-lib=..\\zlib-1.2.8/libs/vc12_Release_MD_Win32/zlib.lib", "VC-WIN32", "--prefix=H:/ZZWorkspace/ZZExtraLibs/openssl-1.1.0c/libs/vc12_Release_DLL_MD_threads_zlib" ],
  prefix => "H:/ZZWorkspace/ZZExtraLibs/openssl-1.1.0c/libs/vc12_Release_DLL_MD_threads_zlib",
  processor => "",
...
our %target = (
  ...
  ex_libs => "..\\zlib-1.2.8/libs/vc12_Release_MD_Win32/zlib.lib ws2_32.lib gdi32.lib advapi32.lib crypt32.lib user32.lib",
  exe_extension => "",
  ld => "link",
  lflags => "/nologo /debug",
...
our %withargs = (
  zlib_include => "../zlib-1.2.8",
  zlib_lib => "..\\zlib-1.2.8/libs/vc12_Release_MD_Win32/zlib.lib",
);
